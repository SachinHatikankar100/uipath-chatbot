...
# Deploys Jenkins with Python 3.11 and Azure CLI for UiPath Chatbot CI/CD

set -e

# Configuration
RESOURCE_GROUP="uipath-chatbot-jenkins-rg"
LOCATION="eastus"
STORAGE_ACCOUNT="uipathbotjenstore626286"
FILE_SHARE="jenkins-data"
ACR_NAME="uipathchatbotjenkinsacr626286"
CONTAINER_NAME="jenkins-research-uipathchatbot"
DNS_NAME_LABEL="jenkins-uipathchatbot-626286"
...
echo "╔════════════════════════════════════════════════════════╗"
echo "║  Deploying Jenkins for UiPath Chatbot     ║"
echo "╚════════════════════════════════════════════════════════╝"
echo ""
